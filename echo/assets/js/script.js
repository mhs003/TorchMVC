...
function navToggle(togBTN){
  var nav_menu = document.getElementById("nav-bd");

  if(msl == 0){
    nav_menu.style.height = "124px";
  ...
  togBTN.classList.toggle("change");
}
...
function setLinkEdit(){
  var urlBox = document.getElementById("urlBox");
  var ubValue = urlBox.value;
  
  if(ubValue.toLowerCase().trim() == "ht" && x == 0){
    urlBox.value = "https://";
    x = 1;
  } else if(ubValue.trim() == ""){
    x = 0;
  }
}